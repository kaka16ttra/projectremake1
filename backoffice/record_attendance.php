                ...
                if ($rs_attendance->num_rows == 0) {
                    ...
                    while ($data_attendance = $rs_attendance->fetch_assoc()) {
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="formedit_attendance.php?id=<?php echo $m_id; ?>&date=<?php echo urlencode($attendance_date); ?>" class="btn btn-warning btn-sm">แก้ไข</a>
                                <a href="del_attendance.php?id=<?php echo $m_id; ?>&date=<?php echo urlencode($attendance_date); ?>" onclick="return confirm('คุณต้องการลบใช่หรือไม่')" class="btn btn-outline-danger btn-sm">ลบ</a>
                            </td>
                        </tr>
                        <?php
                    }
