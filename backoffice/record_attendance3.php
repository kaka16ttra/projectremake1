...
<body>
    <div class="container mt-4">
        ...
        <h2 class="mt-4">จำนวนแถวที่แสดง:</h2>
        <table class="table table-bordered mt-4">
            ...
            <tbody>
                ...
                $sql_select_attendance = "
                    ...
                    FROM members m
                    JOIN attendance3 a ON m.id = a.member_id
                ...
                if ($rs_attendance->num_rows == 0) {
                    ...
                    while ($data_attendance = $rs_attendance->fetch_assoc()) {
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="formedit_attendance3.php?id=<?php echo $m_id; ?>&date=<?php echo urlencode($attendance_date); ?>" class="btn btn-warning btn-sm">แก้ไข</a>
                                <a href="del_attendance3.php?id=<?php echo $m_id; ?>&date=<?php echo urlencode($attendance_date); ?>" onclick="return confirm('คุณต้องการลบใช่หรือไม่')" class="btn btn-outline-danger btn-sm">ลบ</a>
                            </td>
                        </tr>
                        <?php
                    }
