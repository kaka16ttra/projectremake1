...
$sql_select_member_for_edit = "SELECT * FROM attendance3 WHERE member_id = ? AND attendance_date = ?";
...
<body>
    <div class="container mt-4">
        ...
        <form method="POST" action="editupdate_attendance3.php">
            ...
            <a href="record_attendance3.php" class="btn btn-secondary">ยกเลิก</a>
        </form>
    </div>
</body>
</html>
