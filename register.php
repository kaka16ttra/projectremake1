...
<body>
    ...
    <div class="register-container">
        ...
        <br>
        <h6 class="text-center">* สำหรับนักศึกษาวิชาทหารวิทยาลัยอาชีวศึกษาสุราษฎร์ธานีเท่านั้น *</h6>
        <br>
        <br>
        <form action="insert_member.php" method="POST">
            <div class="mb-3">
                <label for="fullname" class="form-label">ชื่อ</label>
                <input type="text" class="form-control" id="fullname" name="fullname" placeholder="กรอกชื่อ-นามสกุล ไม่ต้องมีคำว่า นาย,นางสาว" required>
            </div>
            <div class="mb-3">
                <label for="username" class="form-label">เลขประจำตัว</label>
                <input type="text" class="form-control" id="username" name="username" placeholder="กรอกเลขประจำตัว 10 หลัก *ดูในLINEกลุ่ม*" required>
            </div>
            <div class="mb-3">
